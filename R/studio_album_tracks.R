...
#' \describe{
#'   \item{artist_name}{chr Name}
#'   \item{artist_id}{chr Month price was recorded. Ranges from 1-12 for January - December}
#' }
#' @source <https://github.com/rfordatascience/tidytuesday/tree/master/data/2021/2021-12-14>
"studio_album_tracks"
